                ...
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/2.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            ...
                            <div class="project-name">
                                Automatický převod kódu ve webovém UI (bakalářská práce)
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/3.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                C#.NET | WPF | Entity Framework | MS-SQL
                            </div>
                            <div class="project-name">
                                Evidence vědeckých publikací pro .NET Framework
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/4.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Java 8 | Java ImageIO | JavaFX
                            </div>
                            <div class="project-name">
                                Detekce hran v rastrovém obrázku
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/5.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                PHP 5 | Twig | HTML5&CSS3 | Bootstrap 3 | jQuery UI | MySQL
                            </div>
                            <div class="project-name">
                                Diskusní web (vlastní návrh MVC architektury)
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/6.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            ...
                            <div class="project-name">
                                Kalkulačka pro Android s grafickým zobrazením funkcí
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/7.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                GNU C | Pthreads | BSD Sockets
                            </div>
                            <div class="project-name">
                                Piškvorky po síti (TCP server pro Linux)
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/8.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Java 7 | Swing | Java Networking
                            </div>
                            <div class="project-name">
                                Piškvorky po síti (multiplatformní TCP klient)
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-4 col-sm-6">
                <a class="portfolio-box" href="{{ asset('storage/img/portfolio/fullsize/9.png') }}">
                    ...
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Java 8 | JavaFX | Log4j | HttpComponents | Jackson | Spring-WS
                            </div>
                            <div class="project-name">
                                Monitoring běhu komponent voláním WS se SOAP/REST API (týmový projekt)
                            </div>
                        </div>
                    </div>
                </a>
